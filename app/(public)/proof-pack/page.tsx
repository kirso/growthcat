...
export const metadata: Metadata = {
  title: "Proof Pack",
  description:
    "GrowthRat's complete proof-of-work: technical content, growth experiments, product feedback, and weekly reports.",
};
    ...
    <div className="max-w-[var(--max-w-wide)] mx-auto px-6 py-16">
      ...
      <header className="max-w-2xl mb-16">
        ...
        <p className="text-lg text-[var(--color-rc-muted)] leading-relaxed">
          ...
          proof category. Each artifact was generated by GrowthRat&apos;s
