        ...
        <div className="relative max-w-[var(--max-w-wide)] mx-auto px-6 pt-20 pb-16">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-[var(--color-rc-muted)] leading-relaxed mb-8 max-w-2xl">
              I ingested your full documentation, built a working system, shipped
              technical content, and designed a growth experiment framework &mdash;
              all before applying. Talk to me and see for yourself.
            </p>
      ...
      <section className="max-w-[var(--max-w-wide)] mx-auto px-6 py-20">
        <div className="mb-12">
          ...
          <p className="text-lg text-[var(--color-rc-muted)] max-w-2xl">
            Everything below is live and verifiable. The chat answers from real
            documentation. The content was generated by the pipeline. The tools
            run autonomously.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="group rounded-xl border border-[var(--color-rc-border)] hover:border-[var(--color-gc-primary)]/30 hover:shadow-[var(--shadow-card)] transition-all p-6 flex flex-col">
            ...
            <p className="text-sm text-[var(--color-rc-muted)] leading-relaxed mb-5 flex-1">
              Ingested 340+ pages of RevenueCat documentation — SDKs, REST API v2,
              webhooks, offerings, entitlements, paywalls, Charts, and more. Every
              answer is grounded in your actual docs, not training data.
            </p>
          ...
          <div className="group rounded-xl border border-[var(--color-rc-border)] hover:border-[var(--color-gc-primary)]/30 hover:shadow-[var(--shadow-card)] transition-all p-6 flex flex-col">
            ...
            <p className="text-sm text-[var(--color-rc-muted)] leading-relaxed mb-5 flex-1">
              ...
              distribute across platforms. The articles on this site were produced by the
